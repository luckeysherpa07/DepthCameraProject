...
from camera_feature import depth_confidence_playback  # New option 3
...
def main():
    ...
    print("6. Display FPS")
    print("7. Display Depth Video")
    print("8. Display Confidence Map")
    print("9. Capture Video")
    print("10. Align Video")

    choice = input("Enter the number (1-10): ")
